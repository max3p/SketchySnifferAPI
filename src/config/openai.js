...
CONSTRAINTS:
- Return 2-6 findings (your AI-detected findings only). Do not include rule engine flags in your findings, as they are handled separately.
...
- NEVER use em dashes or hyphens as sentence connectors. Use commas or restructure sentences instead.`;
